                    ...
                    <div class="hero-inner">
                        <div class="content content-full">
                            <div class="py-30 text-center">
                                ...
                                <h1 class="h2 font-w700 mt-30 mb-50">Quiz telah diakhiri</h1>
                                <a class="btn btn-hero btn-rounded btn-alt-secondary" href="{{ url('siswa/ujian') }}">
                                    <i class="fa fa-arrow-left mr-10"></i> Dasbor
                                </a>
                            </div>
                        </div>
                    </div>
